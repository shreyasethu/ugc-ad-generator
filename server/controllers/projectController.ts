...
export const createProject = async (req:Request, res: Response) => {
    ...
    try {
        ...
        try {
            ...
            error.step = 'uploading reference images';
            throw error;
        }
         ...
         try {
            ...
            error.step = 'uploading generated image';
            throw error;
         }
        ...
        Sentry.captureException(error, { extra: { step: error.step, http_code: error.http_code } });
